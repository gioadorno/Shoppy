...
const Navbar = () => {
  ...
  //Gets the size of the user's window so the sidebar won't be open on initial load with smaller screens
  useEffect(() => {
    ...
    return () => window.removeEventListener('resize', handleResize); //always remove window event listener after used in React
  }, []);
